...
class SupportForm {
	...
	public static function init(): void {
        ...
        <form method="post">
            ...
            <fieldset class="wpie-fieldset">
                <legend>
					<?php esc_html_e( 'Support Form', 'bubble-menu' ); ?>
                </legend>
                ...
                <div class="wpie-fields is-column">
					<?php
					$content   = esc_attr__( 'Enter Your Message', 'bubble-menu' );
                ...
                <div class="wpie-fields is-column">
                    ...
                    <div class="wpie-field">
						<?php submit_button( __( 'Send to Support', 'bubble-menu' ), 'primary', 'submit', false ); ?>
                    </div>
                </div>
	...
	private static function send(): void {
		...
		if ( $send ) {
			$text = __( 'Your message has been sent to the support team.', 'bubble-menu' );
			echo '<p class="notice notice-success">' . esc_html( $text ) . '</p>';
		} else {
			$text = __( 'Sorry, but message did not send. Please, contact us via support page.', 'bubble-menu' );
	...
	private static function error(): ?string {
		...
		foreach ( $fields as $field ) {
			if ( empty( $_POST['support'][ $field ] ) ) {
				return __( 'Please fill in all the form fields below.', 'bubble-menu' );
			}
		}
