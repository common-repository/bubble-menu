...
class ListTable extends WP_List_Table {
	...
	public function column_title( $item ): string {
		$title   = ! empty( $item['title'] ) ? $item['title'] : __( 'Untitled', 'bubble-menu' );
	...
	public function get_columns(): array {
		return [
			...
			'mode'   => __( 'Test mode',
					'bubble-menu' ) . '<sup class="has-tooltip" data-tooltip="' . __( 'The item will only be displayed for administrators.',
					'bubble-menu' ) . '">ℹ</sup>',
			'status' => __( 'Status',
					'bubble-menu' ) . '<sup class="has-tooltip" data-tooltip="' . __( 'Display item on the Frontend.',
					'bubble-menu' ) . '">ℹ</sup>',
		];
	}
